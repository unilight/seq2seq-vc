...
def get_parser():
    ...
    parser.add_argument("--text_path", required=True, type=str, help="path of gt text")
...
def main():
    ...
    transcription_path = args.text_path
    ...
    with open(transcription_path, mode="r", encoding="utf-16") as f:
        reader = csv.DictReader(f, delimiter="\t")
        lines = [line for line in reader]
    groundtruths = {line["id"]: line["text"].replace(" ", "") for line in lines}
